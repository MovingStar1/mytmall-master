...
<div class="imgAndInfo">
    ...
    <div class="imgInImgAndInfo">
        <img width="100px" class="bigImg"
             src="<%=request.getContextPath()%>/img/productSingle/${product['productSingleImage'][0]['id']}.jpg"
             alt="图片加载失败">
        <div class="smallImageDiv">
            <c:forEach items="${product.productSingleImage}" var="singleImage">
                <img width="56px" src="<%=request.getContextPath()%>/img/productSingle/${singleImage.id}.jpg"
                     alt="图片加载失败" class="smallImage"
                     bigImageURL="<%=request.getContextPath()%>/img/productSingle/${singleImage.id}.jpg">
            </c:forEach>
        </div>
...
<div class="productDetailDiv" style="display: block">
    ...
    <div class="productDetailImagesPart">
        ...
        <c:forEach items="${product.productDetailImage}" var="detailImage">
            <div>
                <img src="<%=request.getContextPath()%>/img/productDetail/${detailImage.id}.jpg" alt="图片加载失败">
            </div>
