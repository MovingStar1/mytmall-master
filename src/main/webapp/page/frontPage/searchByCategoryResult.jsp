        ...
        <c:forEach items="${productListByCategoryId}" var="product">
            <div class="productUnit" price="${product.promotePrice}">
                <div class="productUnitFrame">
                    <a href="getProductDetail.do?cid=${product.category.id}&pid=${product.id}"><img height="190px" width="100%" src="<%=request.getContextPath()%>/img/productSingle/${product.firstProductImage.id}.jpg" alt="图片加载失败"></a>
