        ...
        <c:choose>
            <c:when test="${orders==null}">
                <div class="orderIsNull" id="orderIsNull">
                    <img src="<%=request.getContextPath()%>/img/site/orderFinish.png" alt="图片加载失败">
                            ...
                            <tr class="orderListItemDetailTR">
                                <td class="orderListItemDetailTD" width="120px">
                                    <a href="getProductDetail.do?pid=${orderItem.product.id}&cid=${orderItem.product.category.id}"><img
                                            ...
                                            src="<%=request.getContextPath()%>/img/productSingle/${orderItem.product.firstProductImage.id}.jpg"
                                            alt="图片加载失败"></a>
                                </td>
...
//                    alert(orderList);
            ...
            img.setAttribute("src", "img/site/TB1LF0CKFXXXXcAXFXXXXXXXXXX-21-20.png");
