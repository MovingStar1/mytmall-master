                ...
                <c:forEach items="${orderItemList}" var="orderItem" varStatus="st">
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD" width="60px">
                            <a href="getProductDetail.do?pid=${orderItem['product']['id']}&cid=${orderItem['product']['category']['id']}"><img class="orderItemImg" src="<%=request.getContextPath()%>/img/productSingle/${orderItem['product']['firstProductImage']['id']}.jpg" alt="图片加载失败" /></a>
                        </td>
